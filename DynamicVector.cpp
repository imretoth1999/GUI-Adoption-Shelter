...
//template<typename T>
//
//DynamicVector<T>& DynamicVector<T>::operator-(const Dog & d)
//{
//	int pos = -1;
...
//template<typename T>
//
//int DynamicVector<T>::add(const Dog& e)
//{
//	/*
...
//template<typename T>
//
//int DynamicVector<T>::updateDog(const int pos, const std::string& breed, const std::string& name, const std::int32_t age, const std::string& photo)
//{
//	/*
//	We update the dog
//	*/
